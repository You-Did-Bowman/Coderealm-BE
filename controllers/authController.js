...
export const verifyUser = async (req, res) => {
  ...
  try {
    ...
    return res.redirect(`${process.env.FE_HOST}/verification-success`); // Redirect on successful verification

  } catch (error) {
    console.error("Verification error:", error);
    res.redirect(`${process.env.FE_HOST}/verification-error`); // Redirect on error
  }
};
